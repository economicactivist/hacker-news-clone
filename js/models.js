...
class StoryList {
  ...
  static async getStories() {
    ...
    //* AND STORES IN A LIST (BECAUSE OF .map)
  ...
  async addStory(user, storyObj) {
    // TODO: UNIMPLEMENTED: complete this function!
    //* the obj only has title, author, url, so storyId and createdAt are likely autogenerated
    /**Original code, but got stuck because I didn't post to the API 
    ...
    //? what do I "await" in this async function??
    // storyId, title, author, url, username, createdAt
    return new Story(newStoryObj)
    [end orginal code] */
    ...
    this.stories.unshift(story) //place story at beginning of list
    user.ownStories.unshift(story) //add story to ownstories list from User class
  ...
  async removeStory(user, storyId) {
    ...
    await axios({
      ...
      method: 'DELETE',
      data: { token }, //changed from {token: user.loginToken }
    })
